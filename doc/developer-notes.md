...
- [Development guidelines](#development-guidelines)
    - [General Diminutivecoin](#general-bitcoin-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Diminutivecoin uses [Doxygen](https://www.doxygen.nl/) to generate its official documentation.
...
Diminutivecoin is a multi-threaded application, and deadlocks or other
...
Diminutivecoin can be compiled with various "sanitizers" enabled, which add
...
However, in open source software such as Diminutivecoin, where everyone uses
...
pay attention to for reviewers of Diminutivecoin code.

General Diminutivecoin
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers.
  ...
  - *Rationale*: Diminutivecoin uses tinyformat, which is type safe. Leave them out to avoid confusion.
...
Some of these are maintained by active developers of Diminutivecoin, in which case changes should probably go
directly upstream without being PRed directly against the project. They will be merged back in the next
subtree merge.

Others are external projects without a tight relationship with our project. Changes to these should also
be sent upstream, but bugfixes may also be prudent to PR against Diminutivecoin so that they can be integrated
...
file descriptors, it will cause problems with Diminutivecoin's `select()` loop, because
...
- Wallet RPCs call BlockUntilSyncedToCurrentChain to maintain consistency with
  ...
  - *Rationale*: In previous versions of Diminutivecoin, the wallet was always
