...
contains(DIMINUTIVECOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += DIMINUTIVECOIN_NEED_QT_PLUGINS
...
HEADERS += src/qt/diminutivecoingui.h \
    ...
    src/qt/diminutivecoinaddressvalidator.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
    src/blockparams.h \
    ...
    src/qt/diminutivecoinamountfield.h \
    src/wallet.h \
    src/keystore.h \
...
SOURCES += src/qt/diminutivecoin.cpp src/qt/diminutivecoingui.cpp \
    ...
    src/qt/diminutivecoinstrings.cpp \
    src/qt/diminutivecoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
    ...
    src/qt/diminutivecoinunits.cpp \
...
# also add new translations to src/qt/diminutivecoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/diminutivecoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/diminutivecoin-qt.rc
...
windows:RC_FILE = src/qt/res/diminutivecoin-qt.rc
