...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s diminutivecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  diminutivecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded diminutivecoin transaction") + "\n" +
              "  diminutivecoin-tx [options] -create [commands]   " + _("Create hex-encoded diminutivecoin transaction") + "\n" +
              "\n";
