...
const char * const BITCOIN_CONF_FILENAME = "diminutivecoin.conf";
const char * const BITCOIN_PID_FILENAME = "diminutivecoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Diminutivecoin";
#else
    // Unix
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    std::string strCopyrightHolders =
        ...
        "\n" + strPrefix + "The Diminutivecoin developers";
