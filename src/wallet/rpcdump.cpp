...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"diminutivecoinaddress\"\n"
            "\nReveals the private key corresponding to 'diminutivecoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"diminutivecoinaddress\"   (string, required) The diminutivecoin address for the private key\n"
            "\nResult:\n"
