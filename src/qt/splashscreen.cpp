    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextDiminutivecoin  = QChar(0xA9)+QString(" %1-%2 ").arg(2020).arg(COPYRIGHT_YEAR) + QString("The Diminutivecoin developers");
    ...
    pixPaint.setPen(QColor(200,210,220));
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+10,copyrightTextBlackmore);
        pixPaint.drawText(x,y+20,copyrightTextDiminutivecoin);
    }
...
static void InitMessage(SplashScreen *splash, const std::string &message)
{
    QMetaObject::invokeMethod(splash, "showMessage",
        ...
        Q_ARG(QColor, QColor(180,190,200)));
}
