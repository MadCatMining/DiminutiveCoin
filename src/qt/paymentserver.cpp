...
const QString BITCOIN_IPC_PREFIX("diminutivecoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/diminutivecoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/diminutivecoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/diminutivecoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click diminutivecoin: links
...
//
// OSX-specific way of handling diminutivecoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in diminutivecoin: URIs
